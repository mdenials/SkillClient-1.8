...
public class GuiMultiplayer extends GuiScreen implements GuiYesNoCallback
{
    ...
    public void initGui() {
        ...
        if (!this.initialized) {
            ...
            (this.serverListSelector = new ServerSelectionList(this, GuiMultiplayer.mc, this.width, this.height, 32, this.height - 64, 36)).func_148195_a(this.savedServerList);
        }
        else {
    ...
    public void createButtons() {
        ...
        this.buttonList.add(new GuiButton(9, this.width / 2 + 160, this.height - 28, 75, 20, "Realms"));
        this.buttonList.add(new GuiButton(10, this.width / 2 + 160, this.height - 52, 75, 20, "Accounts"));
        this.buttonList.add(new SkillGuiCheckBox(1014, this.width / 2 - 240, this.height - 48, "BungeeHack", AccountManager.bungeeHack));
        (this.fakeIP = new GuiTextField(1016, GuiMultiplayer.mc.fontRendererObj, this.width / 2 - 240, this.height - 28, 80, 20)).setText(AccountManager.fakeIP);
    ...
    public void updateScreen() {
        ...
        if (this.lanServerList.getWasUpdated()) {
            final List<LanServerDetector.LanServer> list = (List<LanServerDetector.LanServer>)this.lanServerList.getLanServers();
            this.lanServerList.setWasNotUpdated();
            this.serverListSelector.func_148194_a((List)list);
        }
        this.oldServerPinger.pingPendingNetworks();
        this.fakeIP.updateCursorCounter();
    }
        ...
        if (button.enabled) {
            ...
            if (button.id == 2 && guilistextended$iguilistentry instanceof ServerListEntryNormal) {
                ...
                if (s4 != null) {
                    ...
                    final GuiYesNo guiyesno = new GuiYesNo((GuiYesNoCallback)this, s5, s6, s7, s8, this.serverListSelector.func_148193_k());
                    GuiMultiplayer.mc.displayGuiScreen((GuiScreen)guiyesno);
                }
            }
            else if (button.id == 1) {
                ...
                GuiMultiplayer.mc.displayGuiScreen((GuiScreen)new GuiScreenServerList((GuiScreen)this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
            }
            else if (button.id == 3) {
                this.addingServer = true;
                GuiMultiplayer.mc.displayGuiScreen((GuiScreen)new GuiScreenAddServer((GuiScreen)this, this.selectedServer = new ServerData(I18n.format("selectServer.defaultName", new Object[0]), "", false)));
            }
                ...
                GuiMultiplayer.mc.displayGuiScreen((GuiScreen)new GuiScreenAddServer((GuiScreen)this, this.selectedServer));
            }
            else if (button.id == 0) {
                ...
                GuiMultiplayer.mc.displayGuiScreen((GuiScreen)new GuiAccountManager((GuiScreen)this));
            }
            else if (button.id == 1014) {
                AccountManager.bungeeHack = ((SkillGuiCheckBox)button).isChecked();
            }
        }
    }
    
    private void refreshServerList() {
        GuiMultiplayer.mc.displayGuiScreen((GuiScreen)new GuiMultiplayer(this.parentScreen));
    }
    ...
    public void confirmClicked(final boolean result, final int id) {
        ...
        if (this.deletingServer) {
            ...
            GuiMultiplayer.mc.displayGuiScreen((GuiScreen)this);
        }
    ...
    protected void keyTyped(final char typedChar, final int keyCode) throws IOException {
        ...
        if (this.fakeIP.isFocused()) {
            this.fakeIP.textboxKeyTyped(typedChar, keyCode);
            AccountManager.fakeIP = this.fakeIP.getText();
            return;
        }
        if (keyCode == 63) {
            this.refreshServerList();
    ...
    public void drawScreen(final int mouseX, final int mouseY, final float partialTicks) {
        ...
        if (this.hoveringText != null) {
            this.drawHoveringText((List)Lists.newArrayList(Splitter.on("\n").split((CharSequence)this.hoveringText)), mouseX, mouseY);
        }
        this.fakeIP.drawTextBox();
    }
    ...
    public void connectToServer(final ServerData server) {
        GuiMultiplayer.mc.displayGuiScreen((GuiScreen)new GuiConnecting((GuiScreen)this, GuiMultiplayer.mc, server));
    }
    ...
    protected void mouseClicked(final int mouseX, final int mouseY, final int mouseButton) throws IOException {
        ...
        this.fakeIP.mouseClicked(mouseX, mouseY, mouseButton);
    }
